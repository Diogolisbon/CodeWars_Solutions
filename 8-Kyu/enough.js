...
excluding the driver, on is the number of people on the bus, and wait is the number of people waiting to get on to the bus.
...
console.log(enough(10, 5, 5)); // Output: 0 (He can fit all 5 passengers)
console.log(enough(100, 60, 50)); // Output: 10 (He can't fit 10 out of 50 waiting)