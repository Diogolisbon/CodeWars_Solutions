...
const day = 3;
const month = 9;
console.log(astroDate(day, month));*/
...
rl.question('Enter the day: ', (dayInput) => {
  rl.question('Enter the month: ', (monthInput) => {
    const day = parseInt(dayInput, 10);
    const month = parseInt(monthInput, 10);

    // Call your astroDate function here
    const astroSign = astroDate(day, month);

    console.log(`Your astrological sign is: ${astroSign}`);
